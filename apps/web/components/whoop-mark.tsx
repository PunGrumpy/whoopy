...
export const WhoopMark = ({ className, ...props }: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <title>Whoop Mark</title>
    <defs>
      <path id="a" d="M0 0h37.64v37.64H0z"></path>
    </defs>
    <g transform="translate(.73 .541)" fill="none" fillRule="evenodd">
